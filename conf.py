...
BLOG_AUTHOR = "Курчинский М."  # (translatable)
BLOG_TITLE = "наладка ЦТПК"  # (translatable)
...
BLOG_EMAIL = "itlinmax@gmail.com"
BLOG_DESCRIPTION = "Наладка"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/proverka/", "Проверка знаний"),
        ("/poleznoe/", "Полезное для наладки"),
        ("/about/", "Автор"),
    ),
}
